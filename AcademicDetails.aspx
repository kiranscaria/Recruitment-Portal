    ...
    <form role="form" id="academicDetails" runat="server">
            ...
            <div class="col-md-12">
                <div class="card" visible="true" runat="server">
                        ...
                        <asp:GridView ID="gridPDeg" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Degree Type">
                                    <ItemTemplate>
                                        <asp:DropDownList runat="server" ID="pDegType" class="form-control">
                                ...
                                <asp:TemplateField HeaderText="Year">
                                    <ItemTemplate>
                                        <asp:DropDownList runat="server" class="form-control" ID="pDegYear">
                                            <asp:ListItem Value="" Selected="True">Select</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Subjects">
                                    ...
                                    <FooterTemplate>
                                        <asp:Button ID="ButtonAddP" runat="server" UseSubmitBehavior="false" Text="Add New Row" CssClass="btn btn-warning"
                    ...
                    <div class="card-content table-responsive" id="cardAcademicDetails_1_Preview" visibility="false" runat="server">
                        <asp:GridView ID="GridView1" class="table table-responsive table-hover table-bordered" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="DegreeType">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_DegreeType" runat="server" Text='<%#Eval("DegreeType") %>'></asp:Label>
                                    </ItemTemplate>

                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="DegreeName">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_DegreeName" runat="server" Text='<%#Eval("DegreeName") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Year">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList runat="server" required="true" class="input-sm" ID="txt_Year" Text='<%#Eval("Year") %>'>
                                            <asp:ListItem Value="" Selected="True">Select</asp:ListItem>
                                            <asp:ListItem>2017</asp:ListItem>
                                            <asp:ListItem>2016</asp:ListItem>
                                            <asp:ListItem>2015</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Division">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Division" runat="server" Text='<%#Eval("Division") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm" ID="txt_Division" required="true" onkeypress="filterAlphaNumeric(event)" MaxLength="50" runat="server" Text='<%#Eval("Division") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Percentage/Grade">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Percentage" runat="server" Text='<%#Eval("Percentage") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm" ID="txt_Percentage" required="true" onkeypress="filterDigitsFloat(event)" MaxLength="50" runat="server" Text='<%#Eval("Percentage") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Subjects">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Subjects" runat="server" Text='<%#Eval("Subjects") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm" ID="txt_Subjects" required="true" onkeypress="filterAlphaNumericExt(event)" MaxLength="50" runat="server" Text='<%#Eval("Subjects") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" visible="true" runat="server">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title">Research Degree</h4>
                        <p class="category">Help</p>
                    </div>
                        ...
                        <asp:GridView ID="gridPhdDeg" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Thesis/Dissertation Title">
                                    ...
                                    <FooterStyle HorizontalAlign="Right" />
                                    <FooterTemplate>
                                        <asp:Button ID="ButtonAddPhd" runat="server" UseSubmitBehavior="false" Text="Add New Row" CssClass="btn btn-warning"
                    ...
                    <div class="card-content table-responsive" id="cardAcademicDetails_2_Preview" visibility="false" runat="server">
                        <asp:GridView ID="GridView2" class="table table-responsive table-hover table-bordered" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="DegreeName">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_DegreeName" runat="server" Text='<%#Eval("DegreeName") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="RegistrationDate">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_RegistrationDate" runat="server" Text='<%#Eval("RegistrationDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm datePicker" ID="txt_RegistrationDate" runat="server" Text='<%#Eval("RegistrationDate") %>'
                                            ClientIDMode="Static" data-min-year="1930" data-format="d-m-Y" data-theme="my-style"
                                ...
                                <asp:TemplateField HeaderText="SubmissionDate">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_SubmissionDate" runat="server" Text='<%#Eval("SubmissionDate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm datePicker" ID="txt_SubmissionDate" runat="server" Text='<%#Eval("SubmissionDate") %>'
                                            ClientIDMode="Static" data-min-year="1930" data-format="d-m-Y" data-theme="my-style"
                                            data-large-mode="true" data-large-default="true"></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="ThesisTitle">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_ThesisTitle" runat="server" required="true" onkeypress="filterAlphaNumericExt(event)" MaxLength="100" Text='<%#Eval("ThesisTitle") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox class="input-sm" ID="txt_ThesisTitle" runat="server" Text='<%#Eval("ThesisTitle") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div class="card-content table-responsive" id="cardAcademicDetails_3" runat="server">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2" id="divYear" style="display: none;">
                                <label>Year of Qualification</label><br />
                                <br />
                            ...
                            <div class="form-group col-lg-2" id="divOtherExam" style="display: none;">
                                <label>Name of Examination</label><br />
                                <br />
                            ...
                            <div class="form-group col-lg-2" id="divRollNo" style="display: none;">
                                <label>Certificate No./Roll No.</label><br />
                                <br />
                                <asp:TextBox ID="rollNo" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row text-center">
                            <asp:Button ID="btnSaveNetDetails" Visible="false" CssClass="btn btn-primary btn-sm" runat="server" Text="Save" OnClick="btnSaveNetDetails_Click" />
                        </div>
                    </div>
                    ...
                    <div class="card-content table-responsive col-md-12" id="cardAcademicDetails_3_Preview" visible="false" runat="server">
                        <div class="row">
                            <div class="form-group col-lg-3 col-md-4">
                                <asp:Label runat="server">Whether Qualified Net/JRF/Equivalent Examination ?</asp:Label>
                            </div>
                            <div class="form-group col-lg-2 col-md-2">
                                <asp:Label runat="server">Year of Qualification</asp:Label>
                            </div>

                            <div class="form-group col-lg-2 col-md-4">
                                <asp:Label runat="server">Examination Qualified</asp:Label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2 col-md-6">
                                    <asp:Label runat="server">Certificate No./Roll No.</asp:Label>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-3 col-md-4">
                                <strong>
                                    <asp:Label ID="netQualified" runat="server"></asp:Label></strong>
                            </div>
                            <div class="form-group col-lg-2 col-md-2">
                                <strong>
                                    <asp:Label ID="netQualifiedYear" runat="server"></asp:Label></strong>
                            </div>

                            <div class="form-group col-lg-2 col-md-4">
                                <strong>
                                    <asp:Label ID="examQualifiedName" runat="server"></asp:Label></strong>

                            </div>
                            <div class="row">
                                <div class="form-group col-lg-2 col-md-6">
                                    <strong>
                                        <asp:Label ID="examSubject" required="true" runat="server"></asp:Label></strong>
                                </div>
                                <div class="form-group col-lg-2 col-md-6">
                                    <strong>
                                        <asp:Label ID="examRollNo" required="true" runat="server"></asp:Label></strong>
                                </div>
                            </div><br />
                            <div class="row text-center">
                                <asp:Button ID="btnEditNetDetails" CssClass="btn btn-success btn-sm" UseSubmitBehavior="false" runat="server" Text="Edit details" OnClick="btnEditNetDetails_Click" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="form-group text-center">
            <asp:Button CssClass="btn btn-success btn-lg" ID="btnProceedAcademicDetail" runat="server" Text="Save and Proceed" OnClick="btnProceedAcademicDetail_Click" />
        </div>
        <div class="form-group text-center">
            <asp:Button CssClass="btn btn-success btn-lg" ID="btnSaveAcademicDetail" runat="server" Text="Save and Preview" OnClick="btnSaveAcademicDetail_Click" />
        </div>
